...
public class IconGenerator {
  ...
  public IconGenerator(Context context) {
    ...
    background = new BubbleDrawable(this.context.getResources());
    container = (ViewGroup) LayoutInflater.from(this.context).inflate(R.layout.amu_text_bubble, null);
    rotationLayout = (RotationLayout) container.getChildAt(0);
    contentView = textView = (TextView) rotationLayout.findViewById(R.id.amu_text);
  ...
  public void setContentView(View contentView) {
    ...
    final View view = rotationLayout.findViewById(R.id.amu_text);
